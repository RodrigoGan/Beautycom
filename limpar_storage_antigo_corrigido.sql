-- =====================================================
-- LIMPEZA E OTIMIZAÇÃO DO STORAGE (CORRIGIDO)
-- =====================================================
...
-- =====================================================
-- 2. IDENTIFICAR ARQUIVOS PARA REMOÇÃO (CORRIGIDO)
-- =====================================================
...
WHERE o.metadata->>'size' ~ '^[0-9]+$'
  AND (o.metadata->>'size')::bigint > 25 * 1024 * 1024 -- > 25MB
...
-- =====================================================
-- 6. VERIFICAR RESULTADO DA LIMPEZA (CORRIGIDO)
-- =====================================================
