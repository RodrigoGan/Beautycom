...
const STRIPE_CONFIG = {
  successUrl: process.env.STRIPE_SUCCESS_URL || 'http://localhost:5173/planos?success=true',
  cancelUrl: process.env.STRIPE_CANCEL_URL || 'http://localhost:5173/planos?canceled=true',
